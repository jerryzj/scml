...
class untimed_word_read_extensions_adapter : public word_adapter_base<M>
{
public:
...
public:
  untimed_word_read_extensions_adapter(C& c, CallbackType cb, const M& mem, bool check_word_access = true);
...
{
  return untimed_word_read_extensions_adapter<M, C>(c, cb, mem, check_word_access);
}

template <typename M, typename C>
inline
untimed_word_read_extensions_adapter<M, C>::
untimed_word_read_extensions_adapter(C& c, CallbackType cb, const M& mem, bool check_word_access) :
