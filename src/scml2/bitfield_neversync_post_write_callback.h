 ...
 ***************************************************************************/
#ifndef SCML2_BITFIELD_NEVERSYNC_POST_WRITE_CALLBACK_H
#define SCML2_BITFIELD_NEVERSYNC_POST_WRITE_CALLBACK_H
...
class bitfield_neversync_post_write_callback :
  public bitfield_post_write_callback_base<DT>
{
public:
  bitfield_neversync_post_write_callback(ADAPTER adapter, const std::string& name);
...
template <typename DT, typename ADAPTER>
inline
bitfield_neversync_post_write_callback<DT, ADAPTER>::
bitfield_neversync_post_write_callback(ADAPTER adapter, const std::string& name) :
