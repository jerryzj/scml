...
inline void set_read_no_store(bitfield<DT>& bitfield, SyncType syncType  = AUTO_SYNCING) {
  bitfield.set_read_callback(create_bitfield_read_callback<DT>(bitfield_null_adapter<DT>(), "<read_no_store>", syncType));
}

template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_read_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  assert(c);
  bitfield.set_read_callback(create_bitfield_read_callback<DT>(create_bitfield_read_adapter<DT>(*c, cb), cbName, syncType));
}

template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_untimed_read_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
...
template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_read_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  assert(c);
  bitfield.set_read_callback(create_bitfield_read_callback<DT>(create_bitfield_read_adapter<DT>(*c, cb, id), cbName, syncType));
}

template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_untimed_read_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
...
template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_mask_read_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  assert(c);
  bitfield.set_read_callback(create_bitfield_read_callback<DT>(create_bitfield_read_adapter<DT>(*c, cb), cbName, syncType));
}

template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_untimed_mask_read_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
...
template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_mask_read_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  assert(c);
  bitfield.set_read_callback(create_bitfield_read_callback<DT>(create_bitfield_read_adapter<DT>(*c, cb, id), cbName, syncType));
}

template <typename DT, typename C>
inline void set_read_no_store_callback(bitfield<DT>& bitfield, C* c, typename bitfield_untimed_mask_read_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
...
inline void set_post_write_callback(bitfield<DT>& bitfield, C* c, typename bitfield_post_write_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  ...
  assert(c);
  bitfield.set_post_write_callback(create_bitfield_post_write_callback<DT>(create_bitfield_post_write_adapter<DT>(*c, cb), cbName, syncType));
}
...
inline void set_post_write_callback(bitfield<DT>& bitfield, C* c, typename bitfield_post_write_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  ...
  assert(c);
  bitfield.set_post_write_callback(create_bitfield_post_write_callback<DT>(create_bitfield_post_write_adapter<DT>(*c, cb, id), cbName, syncType));
}

template <typename DT, typename C>
inline void set_post_write_callback(bitfield<DT>& bitfield, C* c, typename bitfield_post_write_old_new_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
  ...
  assert(c);
  bitfield.set_post_write_callback(create_bitfield_post_write_callback<DT>(create_bitfield_post_write_old_new_adapter<DT>(*c, cb), cbName, syncType));
}

template <typename DT, typename C>
inline void set_post_write_callback(bitfield<DT>& bitfield, C* c, typename bitfield_post_write_old_new_adapter_tagged<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType, int id) {
  if (syncType == SELF_SYNCING) {
    SCML2_LOG(bitfield.get_streams().error())
      << "SELF_SYNCING not supported for untimed callbacks on '"
      << bitfield.get_name() << "'"
  ...
  assert(c);
  bitfield.set_post_write_callback(create_bitfield_post_write_callback<DT>(create_bitfield_post_write_old_new_adapter<DT>(*c, cb, id), cbName, syncType));
}
...
template <typename BITFIELD_TYPE, typename C>
inline void set_post_write_callback(BITFIELD_TYPE& bitfield, typename BITFIELD_TYPE::Enums enumval, C* c, typename bitfield_post_write_old_new_adapter<typename BITFIELD_TYPE::data_type,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  assert(c);
  bitfield.set_post_write_callback(enumval, create_bitfield_post_write_callback<typename BITFIELD_TYPE::data_type>(create_bitfield_post_write_old_new_adapter<typename BITFIELD_TYPE::data_type>(*c, cb), cbName, syncType));
}

template <typename DT, typename C>
inline void set_post_write_callback(bitfield<DT>& bitfield, DT enumval, C* c, typename bitfield_post_write_old_new_adapter<DT,C>::CallbackType cb, const std::string& cbName, SyncType syncType = AUTO_SYNCING) {
  assert(c);
  bitfield.set_post_write_callback(enumval, create_bitfield_post_write_callback<DT>(create_bitfield_post_write_old_new_adapter<DT>(*c, cb), cbName, syncType));
}
